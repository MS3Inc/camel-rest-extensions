...
/**
 * This OpenApi4jValidator class uses the openapi4j library for validation.
...
public class OpenApi4jValidator extends AsyncProcessorSupport {
     ...
     * and creates a {@link RequestValidator} instance based on the OpenApi3 instance.
     *
     ...
     * The base path is added to the object and a {@link RequestValidator} instance is created based on the OpenApi3 instance.
     *
     * @param specPath location of specification in resources
    ...
    /**
     * Parses the {@link ValidationResults} report and returns the details and diagnostics
     * of the bad request.
     *
