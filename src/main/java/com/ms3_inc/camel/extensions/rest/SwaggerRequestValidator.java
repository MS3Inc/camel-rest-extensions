...
/**
 * This SwaggerRequestValidator class uses the Atlassian swagger-request-validator
 * library for validation. This library supports only JSON validation.
 * <p>
...
public class SwaggerRequestValidator extends AsyncProcessorSupport {
    ...
    /**
     * Constructs a validator using an {@link OpenApiInteractionValidator} instance.
     *
    ...
    /***
     * Constructs a validator using an {@link OpenApiInteractionValidator} instance,
     * overriding the base path provided in the specification or setting the
     * base path if it hasn't been provided in the specification.
     *
     * @param specPath location of specification in resources
    ...
    /**
     * Parses the report and returns the details and diagnostics
     * of the bad request.
     *
     * @param report    the report generated by the validator
     * @return the Message with all of the information about the error
     */
    ...
    /**
     * Builds the request from the {@link Exchange} using the builder pattern.
     * First initializes the needed headers and values from the exchange.
     * If the body is not empty, it gets added to the request.
     * Adds the query params and the necessary headers to the request.
     *
     * @param exchange the entire Exchange object of the request
     * @return the Request built from the necessary exchange values
     */
